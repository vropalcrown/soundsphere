...
const GenerateSubtitleOutputSchema = z.object({
  subtitle: z.string().describe('The generated subtitle, corrected for grammar and context.'),
});
...
Your task is to correct any transcription errors, add appropriate punctuation, and format it as a single, clear subtitle line. The subtitle should be concise.
